...
type FSharpCompilerServiceChecker =
  ...
  static member GetDependingProjects:
    ...
    options: seq<string * FSharpProjectSnapshot> ->
      (FSharpProjectSnapshot * FSharpProjectSnapshot list) option
  ...
  member GetDeclarations:
    fileName: string<LocalPath> * snapshot: FSharpProjectSnapshot -> Async<NavigationTopLevelDeclaration array>
