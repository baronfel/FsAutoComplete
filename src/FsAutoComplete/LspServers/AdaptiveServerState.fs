      ...
      if config.EnableAnalyzers then
        ...
        try
          ...
          | Some tast ->
            ...
            let! ct = Async.CancellationToken
            notifications.Trigger(NotificationEvent.AnalyzerMessage(Array.empty, file, volatileFile.Version), ct)
        ...
        try
          ...
          | NotificationEvent.AnalyzerMessage(messages, file, version) ->
            ...
            | messages ->
              ...
              diagnosticCollections.SetFor(uri, "F# Analyzers", version, Array.empty)
